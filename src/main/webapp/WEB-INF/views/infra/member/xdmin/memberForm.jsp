          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="/movie/timetable" class="menu-link">
							...
							<form>
								...
								<div class="row">
									<div class="col-6 p-2">
										...
										<div class="col p-2">
											<div class="form-check form-check-inline">	
												<input class="form-check-input" type="radio" value ="일반" name="inputGrade" id="gradeNomal">
												<label class="form-check-label" for="gradeNomal">일반</label>
											</div>
											<div class="form-check form-check-inline">
												<input class="form-check-input" type="radio" value ="실버" name="inputGrade" id="gradeSilver">
												<label class="form-check-label" for="gradeSilver">실버</label>
											</div>
											<div class="form-check form-check-inline">
												<input class="form-check-input" type="radio" value ="골드" name="inputGrade" id="gradeGold">
												<label class="form-check-label" for="gradeGold">골드</label>
											</div>	
											<div class="form-check form-check-inline">
												<input class="form-check-input" type="radio" value ="VIP" name="inputGrade" id="gradeVIP">
								...
								<div class="row mb-3">
									...
									<div class="col-sm-10">
										<div class="form-check form-check-inline mt-3">
											<input class="form-check-input" type="radio" value ="동의" name="inputEmailNy" id="emailYes">
											<label class="form-check-label" for="EmailYes">동의</label>
										</div>
										<div class="form-check form-check-inline mt-3">	
											<input class="form-check-input" type="radio" value ="동의안함" name="inputEmailNy" id="emailNo">
								...
								<div class="row mb-3">
									...
									<div class="col-sm-10">
										<div class="form-check form-check-inline mt-3">
											<input class="form-check-input" type="radio" value ="동의" name="inputSmsNy" id="smsYes">
											<label class="form-check-label" for="smsYes">동의</label>
										</div>
										<div class="form-check form-check-inline mt-3">	
											<input class="form-check-input" type="radio" value ="동의안함" name="inputSmsNy" id="smsNo">
								...
								<div class="row mb-3">
									...
									<div class="col-sm-10">
										<div class="form-check form-check-inline mt-3">
											<input class="form-check-input" type="radio" value ="동의" name="inputDobLogin" id="dobLoginY">
											<label class="form-check-label" for="dobLoginY">동의</label>
										</div>
										<div class="form-check form-check-inline mt-3">	
											<input class="form-check-input" type="radio" value ="동의안함" name="inputDobLogin" id="dobLoginN">
								...
								<div class="row mb-3">
									...
									<div class="col-sm-10">
										<div class="form-check form-check-inline mt-3">
											<input class="form-check-input" type="checkbox" value ="페이스북" id="loginFacebook">
											<label class="form-check-label" for="loginFacebook">페이스북</label>
										</div>	
										<div class="form-check form-check-inline mt-3">
											<input class="form-check-input" type="checkbox" value ="네이버" id="loginNaver">
											<label class="form-check-label" for="loginNaver">네이버</label>
										</div>	
										<div class="form-check form-check-inline mt-3">
											<input class="form-check-input" type="checkbox" value ="카카오" id="loginKakao">
