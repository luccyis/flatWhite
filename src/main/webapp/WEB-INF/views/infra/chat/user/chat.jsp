...
<body> 
	                            	...
	                            	<c:forEach items="${list }" var="list" varStatus="status">
		                                    ...
		                                    <div class="d-flex bd-highlight">
		                                        <div class="img_cont">
		                                            ...
		                                            <img src="../resources/images/profile-default.png" class="rounded-circle user_img">
		                                        </div>
  ...
  //Firebase 프로젝트에서 추출한 정보 입력
    	...
    	apiKey: "AIzaSyBP_6uDwhHmqSz-a3P80nmT7F88Fdy5yFM",
    	authDomain: "spacemarket-3e785.firebaseapp.com",
    	databaseURL: "https://spacemarket-3e785-default-rtdb.firebaseio.com",
    	projectId: "spacemarket-3e785",
    	storageBucket: "spacemarket-3e785.appspot.com",
    	messagingSenderId: "304888258988",
    	appId: "1:304888258988:web:04fa1d60fe60a1d0d69a09"
  	};	
	// Initialize Firebase
