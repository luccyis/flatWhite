...
public class Timetable extends Base{
	...
	public void setTdttDelNy(String tdttDelNy) {
		this.tdttDelNy = tdttDelNy;
	}
	...
	public String getTdthAddress() {
		return tdthAddress;
	}
	public void setTdthAddress(String tdthAddress) {
		this.tdthAddress = tdthAddress;
	}
	public String getTdthZipCode() {
		return tdthZipCode;
	}
	public void setTdthZipCode(String tdthZipCode) {
		this.tdthZipCode = tdthZipCode;
	}
	...
	public String getTradTheaterPlex_tdpxSeq() {
		return tradTheaterPlex_tdpxSeq;
	}
	public void setTradTheaterPlex_tdpxSeq(String tradTheaterPlex_tdpxSeq) {
		this.tradTheaterPlex_tdpxSeq = tradTheaterPlex_tdpxSeq;
	}
	public String getTradMovie_tdmvSeq() {
		return tradMovie_tdmvSeq;
	}
	public void setTradMovie_tdmvSeq(String tradMovie_tdmvSeq) {
		this.tradMovie_tdmvSeq = tradMovie_tdmvSeq;
	}
